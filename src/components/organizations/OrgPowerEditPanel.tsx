...
export default function OrgPowerEditPanel({ entryId, categoryId, onClose }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <input type="text" className="input w-full text-sm" placeholder="如：冒险者公会" value={name} onChange={(e) => setName(e.target.value)} autoFocus />
      </div>
