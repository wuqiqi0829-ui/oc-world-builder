  ...
  return (
    <Card hover padding="sm" onClick={onClick} className={clsx(selected && 'ring-2 ring-primary-500')}>
      <div className="flex gap-3">
        <div className="w-16 h-16 rounded-xl bg-[rgb(var(--color-bg))] overflow-hidden flex-shrink-0 border border-[rgb(var(--color-border))]">
          {avatar ? (
        ...
        <div className="flex-1 min-w-0">
          ...
          {character.nickname && (
            <p className="text-xs text-[rgb(var(--color-text-secondary))]">「{character.nickname}」</p>
          )}
