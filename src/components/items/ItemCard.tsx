      ...
      <div className="relative group">
        ...
        {showHandle && (
          <button {...attributes} {...listeners}
            className="absolute top-1 left-1 p-1 rounded bg-white/70 dark:bg-white/10 backdrop-blur-sm text-primary-400 border border-white/50 shadow-sm cursor-grab active:cursor-grabbing hover:bg-white/90 dark:hover:bg-white/20 transition-colors touch-none"
